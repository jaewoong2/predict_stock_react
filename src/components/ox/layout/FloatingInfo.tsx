  ...
  return (
    <AnimatePresence>
      {showDock && (
        <motion.div
          className={cn(
            "fixed inset-x-0 top-4 left-1/2 z-[60] -translate-x-1/2 supports-[env(safe-area-inset-top)]:pt-[calc(env(safe-area-inset-top)+8px)] sm:top-20 sm:right-auto sm:left-1/2 sm:-translate-x-1/2 sm:px-0",
            className,
          )}
        ...
        >
          <LayoutGroup id="floating-info">
            <div
              className={cn(
                "mx-auto flex w-full justify-center px-4 sm:px-0",
                isMobile ? "max-w-[360px]" : "",
              )}
            >
              {isMobile ? (
                <motion.div
                  className="relative flex w-full items-center gap-3 rounded-2xl border border-slate-200 bg-white px-3 py-2 text-[11px] shadow-md ring-1 ring-black/5 dark:border-white/12 dark:bg-[#121624]/90 dark:text-slate-50 dark:ring-white/10"
                ...
                >
                  <div className="flex flex-1 flex-wrap items-center gap-2">
                    ...
                    {isAuthenticated ? (
                      ...
                      <button
                        type="button"
                        onClick={showLogin}
                        className="text-left text-[11px] font-medium text-slate-600 underline-offset-2 transition hover:underline focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-400/60 dark:text-slate-300 dark:focus-visible:ring-white/20"
                      >
                        로그인하면 예측 정보를 확인할 수 있어요
                      </button>
                    )}
                    {isAuthenticated && cooldownSummaryText ? (
                      <div className="flex items-center gap-1 text-[11px] font-medium text-slate-600 dark:text-slate-200">
                  ...
                  {isAuthenticated ? (
                    <div className="flex items-center gap-1 rounded-full bg-slate-100 px-2 py-1 text-[11px] font-semibold text-slate-900 dark:bg-white/10 dark:text-slate-50">
                    ...
                    <button
                      type="button"
                      onClick={showLogin}
                      className="rounded-full border border-slate-200 px-3 py-1 text-[11px] font-semibold text-slate-700 transition hover:bg-slate-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-400/60 dark:border-white/15 dark:text-slate-50 dark:hover:bg-white/10 dark:focus-visible:ring-white/20"
                    >
                      로그인
                    </button>
                  )}
