      ...
      <nav className="sticky top-0 z-40 border-b border-slate-200 bg-white/80 backdrop-blur-lg dark:border-slate-800 dark:bg-[#0f1118]/80">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-end gap-4 px-4 sm:px-6 lg:px-8">
          ...
          <button
            ...
            className={cn(
              "group flex h-10 max-w-2xl flex-1 items-center gap-3 rounded-lg border border-slate-200 bg-slate-50 px-4 transition-all hover:border-slate-300 hover:bg-white dark:border-slate-800 dark:bg-[#151b24] dark:hover:border-slate-700 dark:hover:bg-[#1a2030]",
            )}
          >
            ...
            <kbd className="hidden items-center gap-1 rounded bg-slate-200 px-2 py-0.5 text-xs font-medium text-slate-600 sm:inline-flex dark:bg-slate-800 dark:text-slate-400">
